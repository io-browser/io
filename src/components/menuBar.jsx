...
export default function MenuBar() {
  ...
  return (
    <div className="bg-shark-950 w-[260px] flex-1 p-2 text-shark-200 h-full text-sm">
      <ul className="flex flex-col gap-2">
        <li>
          <button
            className="hover:bg-shark-900 cursor-pointer rounded w-full text-left p-2 flex items-center justify-between"
            onClick={handleCreateNewTab}
          >
            <span className="flex items-center gap-1">
              <ArchiveBoxIcon className="size-4 mx-1" /> New Tab
            </span>
            <span className="bg-shark-700 p-1 rounded text-[8px]">Ctr + N</span>
          </button>
        </li>
        <li>
          <button
          ...
          >
            <span className="flex items-center gap-1">
              <ArchiveBoxXMarkIcon className="size-4 mx-1" />
              Close Tab
            </span>
            <span className="bg-shark-700 p-1 rounded text-[8px]">Ctr + W</span>
          </button>
        </li>
        ...
        <li>
          ...
          >
            <span className="flex items-center gap-1">
              <ArrowPathRoundedSquareIcon className="size-4 mx-1" />
              Regresh Page
            </span>
            <span className="bg-shark-700 p-1 rounded text-[8px]">Ctr + R</span>
          </button>
        </li>
        <li>
          <button
          ...
          >
            <span className="flex items-center gap-1">
              <BookmarkIcon className="size-4 mx-1" />
              Bookmark This Tab
            </span>
            <span className="bg-shark-700 p-1 rounded text-[8px]">Ctr + D</span>
          </button>
        </li>
        <hr className="text-shark-800" />
        <li>
          ...
          >
            <span className="flex items-center gap-1">
              <ArrowPathIcon className="size-4 mx-1" />
              History
            </span>
            <span className="bg-shark-700 p-1 rounded text-[8px]">Ctr + H</span>
          </button>
        </li>
        <li>
          <button
          ...
          >
            <span className="flex items-center gap-1">
              <ArrowDownTrayIcon className="size-4 mx-1" />
              Downloads
            </span>
            <span className="bg-shark-700 p-1 rounded text-[8px]">Ctr + J</span>
          </button>
        </li>
        <li>
          <button
          ...
          >
            <span className="flex items-center gap-1">
              <BookOpenIcon className="size-4 mx-1" />
              Bookmarks
            </span>
            <span className="bg-shark-700 p-1 rounded text-[8px]">
              Ctr + Shift + O
            </span>
          </button>
        </li>
        ...
        <li>
          ...
          >
            <span className="flex items-center gap-1">
              <CommandLineIcon className="size-4 mx-1" />
              Dev Tools
            </span>
            <span className="bg-shark-700 p-1 rounded text-[8px]">
              Ctr + Shift + I
        ...
        <li>
          ...
          >
            <span className="flex items-center gap-1">
              <XMarkIcon className="size-4 mx-1" />
              Exist
            </span>
          </button>
        </li>
